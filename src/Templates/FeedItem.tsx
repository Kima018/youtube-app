...
function FeedItem({thumbnail, channelTitle, viewCount, title, publishedAt,categoryID,videoID}) {
    return <Link to={`video/${categoryID}/${videoID}`} className='cursor-pointer hover:bg-opacity-20 hover:bg-neutral-500 rounded-xl p-2'>
